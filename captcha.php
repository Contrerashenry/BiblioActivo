...
$im = imagecreate(45, 34) or die("Ha ocurrido un error, librería de funciones GD no disponible");
$color_fondo = imagecolorallocate($im, 33, 133, 208);
...
setcookie('captcha', sha1($captcha), time()+60*5);
